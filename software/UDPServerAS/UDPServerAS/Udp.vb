...
Module Udp
    ...
    Public Sub udpAudioThread()
        ...
        ThreadReceive = New Thread(AddressOf ReceiveAudioMessages)
    ...
    Public Sub ReceiveAudioMessages()
        While (UDPAudioStatus)
            ...
            Try
                ...
                Dim strReturnData As String = Encoding.Unicode.GetString(receiveBytes)
    ...
    Public Function RecieveUDP()
        ...
        Try
            Dim RemoteIpEndPoint2 As New System.Net.IPEndPoint(System.Net.IPAddress.Any, 11319)
            Dim udpData As Byte() = UdpSender.Receive(RemoteIpEndPoint2)
            Return ASCIIEncoding.ASCII.GetString(udpData, 0, udpData.Length)
