...
public static RemoteObject _bconnect = RemoteObject.createImmutable(false);
public static b4a.example.udpmodul _udpmodul = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"bConnect",main._bconnect,"btnManual",main.mostCurrent._btnmanual,"btnMute",main.mostCurrent._btnmute,"btnSync",main.mostCurrent._btnsync,"EditText1",main.mostCurrent._edittext1,"ImageView1",main.mostCurrent._imageview1,"lblUnit1",main.mostCurrent._lblunit1,"lblUnit2",main.mostCurrent._lblunit2,"lblUnit3",main.mostCurrent._lblunit3,"lblUnit4",main.mostCurrent._lblunit4,"pnlUnits",main.mostCurrent._pnlunits,"streamer",main._streamer,"Timer",main._timer,"UDPmodul",Debug.moduleToString(b4a.example.udpmodul.class),"UDPsocket1",main._udpsocket1,"UDPsocket2",main._udpsocket2,"UDPsocket3",main._udpsocket3};
}
}