...
try {
		Debug.PushSubsStack("btnManual_click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,102);
...
try {
		Debug.PushSubsStack("btnMute_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,75);
...
try {
		Debug.PushSubsStack("btnOK_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,127);
...
try {
		Debug.PushSubsStack("btnSync_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,71);
...
try {
		Debug.PushSubsStack("txtManIP_EnterPressed (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,113);
...
try {
		Debug.PushSubsStack("UpdateUI (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,88);
