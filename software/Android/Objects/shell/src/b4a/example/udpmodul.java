...
public static b4a.example.main _main = null;
  public Object[] GetGlobals() {
		return new Object[] {"AHEIP",udpmodul._aheip,"ConnectionStatus",udpmodul._connectionstatus,"Main",Debug.moduleToString(b4a.example.main.class),"Service",udpmodul.mostCurrent._service,"streamer",udpmodul._streamer,"Ticks",udpmodul._ticks,"Timer1",udpmodul._timer1,"UDPsocket1",udpmodul._udpsocket1,"UDPsocket2",udpmodul._udpsocket2,"UDPsocket3",udpmodul._udpsocket3,"Unit1",udpmodul._unit1,"Unit2",udpmodul._unit2,"Unit3",udpmodul._unit3,"Unit4",udpmodul._unit4};
}
}