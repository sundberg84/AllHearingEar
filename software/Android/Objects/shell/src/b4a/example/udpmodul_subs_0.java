...
try {
		Debug.PushSubsStack("astream_NewData (udpmodul) ","udpmodul",1,udpmodul.processBA,udpmodul.mostCurrent,140);
...
Debug.locals.put("Buffer", _buffer);
 BA.debugLineNum = 140;BA.debugLine="Sub astream_NewData (Buffer() As Byte)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 141;BA.debugLine="streamer.Write(Buffer)";
Debug.ShouldStop(4096);
udpmodul._streamer.runVoidMethod ("Write",(Object)(_buffer));
 BA.debugLineNum = 142;BA.debugLine="If Main.mute = False Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("=",udpmodul.mostCurrent._main._mute,udpmodul.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 143;BA.debugLine="streamer.StartPlaying";
...
try {
		Debug.PushSubsStack("astream_Stop (udpmodul) ","udpmodul",1,udpmodul.processBA,udpmodul.mostCurrent,148);
if (RapidSub.canDelegate("astream_stop")) return udpmodul.remoteMe.runUserSub(false, "udpmodul","astream_stop");
 BA.debugLineNum = 148;BA.debugLine="Sub astream_Stop";
Debug.ShouldStop(524288);
 BA.debugLineNum = 149;BA.debugLine="streamer.StopPlaying";
...
udpmodul._notis.runVoidMethod ("setIcon",BA.ObjectToString("icon"));
 BA.debugLineNum = 39;BA.debugLine="notis.OnGoingEvent=True";
Debug.ShouldStop(64);
udpmodul._notis.runVoidMethod ("setOnGoingEvent",udpmodul.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 40;BA.debugLine="notis.Vibrate=False";
Debug.ShouldStop(128);
udpmodul._notis.runVoidMethod ("setVibrate",udpmodul.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 41;BA.debugLine="notis.Sound=False";
Debug.ShouldStop(256);
udpmodul._notis.runVoidMethod ("setSound",udpmodul.mostCurrent.__c.getField(true,"False"));
...
Debug.ShouldStop(262144);
 BA.debugLineNum = 52;BA.debugLine="UDPsocket1.Close";
Debug.ShouldStop(524288);
udpmodul._udpsocket1.runVoidMethod ("Close");
 BA.debugLineNum = 53;BA.debugLine="UDPsocket2.Close";
Debug.ShouldStop(1048576);
udpmodul._udpsocket2.runVoidMethod ("Close");
 BA.debugLineNum = 54;BA.debugLine="UDPsocket3.Close";
Debug.ShouldStop(2097152);
udpmodul._udpsocket3.runVoidMethod ("Close");
 BA.debugLineNum = 55;BA.debugLine="notis.OnGoingEvent=False";
Debug.ShouldStop(4194304);
udpmodul._notis.runVoidMethod ("setOnGoingEvent",udpmodul.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("Timer1_Tick (udpmodul) ","udpmodul",1,udpmodul.processBA,udpmodul.mostCurrent,109);
...
Debug.ShouldStop(4096);
 BA.debugLineNum = 111;BA.debugLine="Ticks = Ticks + 1";
Debug.ShouldStop(16384);
udpmodul._ticks = RemoteObject.solve(new RemoteObject[] {udpmodul._ticks,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 112;BA.debugLine="Unit4 = Ticks";
Debug.ShouldStop(32768);
udpmodul._unit4 = BA.NumberToString(udpmodul._ticks);
 BA.debugLineNum = 114;BA.debugLine="UpdateUI";
Debug.ShouldStop(131072);
_updateui();
 BA.debugLineNum = 116;BA.debugLine="If Ticks > 8 And AHEIP <> \"\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean(">",udpmodul._ticks,BA.numberCast(double.class, 8)) && RemoteObject.solveBoolean("!",udpmodul._aheip,BA.ObjectToString(""))) { 
 BA.debugLineNum = 118;BA.debugLine="SendUDP(UDPsocket1, \"0\", AHEIP, 11319)";
Debug.ShouldStop(2097152);
_sendudp(udpmodul._udpsocket1,BA.ObjectToString("0"),udpmodul._aheip,BA.NumberToString(11319));
 };
 BA.debugLineNum = 121;BA.debugLine="If Ticks > 11 Then";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean(">",udpmodul._ticks,BA.numberCast(double.class, 11))) { 
 BA.debugLineNum = 122;BA.debugLine="ConnectionStatus = False";
Debug.ShouldStop(33554432);
udpmodul._connectionstatus = udpmodul.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 123;BA.debugLine="ToastMessageShow(\"You lost connection to AHE\",";
Debug.ShouldStop(67108864);
udpmodul.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToString("You lost connection to AHE")),(Object)(udpmodul.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 124;BA.debugLine="Unit1 = AHEIP";
Debug.ShouldStop(134217728);
udpmodul._unit1 = udpmodul._aheip;
 BA.debugLineNum = 125;BA.debugLine="Unit2 =\"Status: Disconnected\"";
Debug.ShouldStop(268435456);
udpmodul._unit2 = BA.ObjectToString("Status: Disconnected");
 BA.debugLineNum = 126;BA.debugLine="Unit3 =\"Try pressing the Sync AHE button!\"";
Debug.ShouldStop(536870912);
udpmodul._unit3 = BA.ObjectToString("Try pressing the Sync AHE button!");
 BA.debugLineNum = 127;BA.debugLine="Unit4 =\"Check that your hardware is powered!\"";
Debug.ShouldStop(1073741824);
udpmodul._unit4 = BA.ObjectToString("Check that your hardware is powered!");
 BA.debugLineNum = 128;BA.debugLine="notis.SetInfo(\"All hearing ear\", \"You lost conn";
Debug.ShouldStop(-2147483648);
udpmodul._notis.runVoidMethod ("SetInfo",udpmodul.processBA,(Object)(BA.ObjectToString("All hearing ear")),(Object)(BA.ObjectToString("You lost connection to All hearing ear")),(Object)(udpmodul.getObject()));
 BA.debugLineNum = 129;BA.debugLine="notis.Notify(1)";
Debug.ShouldStop(1);
udpmodul._notis.runVoidMethod ("Notify",(Object)(BA.numberCast(int.class, 1)));
 BA.debugLineNum = 130;BA.debugLine="Timer1.Enabled = False";
Debug.ShouldStop(2);
udpmodul._timer1.runMethod(true,"setEnabled",udpmodul.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 131;BA.debugLine="Ticks = 0";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("UpdateUI (udpmodul) ","udpmodul",1,udpmodul.processBA,udpmodul.mostCurrent,153);
if (RapidSub.canDelegate("updateui")) return udpmodul.remoteMe.runUserSub(false, "udpmodul","updateui");
 BA.debugLineNum = 153;BA.debugLine="Private Sub UpdateUI";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 154;BA.debugLine="CallSub(Main, \"UpdateUI\")";
Debug.ShouldStop(33554432);
